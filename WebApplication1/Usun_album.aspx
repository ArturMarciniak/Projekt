<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Usun_album.aspx.cs" Inherits="WebApplication1.Usun_album" %>
...
<body bgcolor="#ffd480">
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:dbad_s426187ConnectionString %>" SelectCommand="SELECT * FROM [PprAlbum]"></asp:SqlDataSource>

            <br /><br />
            <font size="5.5">Podaj Id albumu:&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="IdAlbumu" runat="server" ></asp:TextBox><br />
